...
namespace NominaSoft.Tests
{
    public class TestUnitBoletaPago
    {
        ...
        public void TestCalcularTotalHorasBoleta1()
        {
            ...
            {
                FechaInicio = DateTime.ParseExact("01/03/2019", "dd/MM/yyyy", null),
                FechaFin = DateTime.ParseExact("28/06/2019", "dd/MM/yyyy", null)
            };
        ...
        public void TestCalcularTotalHorasBoleta2()
        {
            ...
            PeriodoPago periodo = new PeriodoPago
            {
                FechaInicio = DateTime.ParseExact("01/01/2019", "dd/MM/yyyy", null),
                FechaFin = DateTime.ParseExact("30/07/2019", "dd/MM/yyyy", null)
            };
            BoletaPago boleta = new BoletaPago
            {
                Contrato = contrato,
        ...
        public void TestCalcularTotalHorasBoleta3()
        {
            ...
            PeriodoPago periodo = new PeriodoPago
            {
                FechaInicio = DateTime.ParseExact("11/03/2019", "dd/MM/yyyy", null),
                FechaFin = DateTime.ParseExact("20/12/2019", "dd/MM/yyyy", null)
            };
            BoletaPago boleta = new BoletaPago
            {
                Contrato = contrato,
        ...
        public void TestCalcularTotalHorasBoleta4()
        {
            ...
            PeriodoPago periodo = new PeriodoPago
            {
                FechaInicio = DateTime.ParseExact("23/05/2019", "dd/MM/yyyy", null),
                FechaFin = DateTime.ParseExact("22/10/2019", "dd/MM/yyyy", null)
            };
            BoletaPago boleta = new BoletaPago
            {
                Contrato = contrato,
        ...
        public void TestCalcularTotalHorasBoleta5()
        {
            ...
            PeriodoPago periodo = new PeriodoPago
            {
                FechaInicio = DateTime.ParseExact("10/07/2019", "dd/MM/yyyy", null),
                FechaFin = DateTime.ParseExact("04/02/2020", "dd/MM/yyyy", null)
            };
            BoletaPago boleta = new BoletaPago
            {
                Contrato = contrato,
